...
export default function AdminLoginPage() {
  ...
  const alreadyAdmin = useMemo(() => {
    if (!session?.user?.email || !adminEmail) return false;
      ...
      >
        ...
        <button
          ...
          style={{
            ...
            borderRadius: 999,
            border: 0,
            background: loading ? "rgba(24,24,26,0.6)" : "#18181a",
            color: "#f8f6f2",
        ...
        <div style={{ marginTop: 12, color: "#7a7888", fontSize: 13 }}>
          Admin email is controlled by <code>NEXT_PUBLIC_ADMIN_EMAIL</code>.
        </div>
      </form>
    </div>
  );
